...
INSERT INTO toydata (id, name, book_price, description) values (4, 'Барт Симпсон', 1337, 'Лютый дебошир стрелок, амогус вахтанг римский гей юлий цезарь ром крут') ON CONFLICT (id) DO NOTHING;
